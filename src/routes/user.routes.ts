...
router.get('/auth/google/register', strictLimiter, user.googleParticipantRedirect);         

router.get('/auth/google/register/callback', user.googleParticipantCallback)

router.post('/register', user.partcipantRegister)

router.get('/auth/google/login', strictLimiter, user.googleParticipantLoginRedirect);         

router.get('/auth/google/login/callback', user.googleParticipantLoginCallback)


router.get('/auth/google/admin/register', strictLimiter, user.googleAdminRedirect);         

router.get('/auth/google/admin/register/callback', user.googleAdminCallback)

router.post('/admin/register', user.adminRegister)

router.get('/auth/google/admin/login', strictLimiter, user.googleAdminLoginRedirect);         

router.get('/auth/google/admin/login/callback', user.googleAdminLoginCallback)


router.get('/auth/google/superAdmin/login', strictLimiter, user.googleSuperadminLoginRedirect);         
